import torch
import pickle
from inference import generate_text, generate_text_with_debug
...
# input_text = "Once upon a time, there was a little cat who wanted to fly."
input_text = "Write a short story about a dog that finds a magic bone."
# input_ids = tokenizer.encode(input_text)
# input_ids = torch.tensor(input_ids, dtype=torch.long).to(config.device)

print("begin the inference")
# 推理
output_text = generate_text(model=model, tokenizer=tokenizer, prompt=input_text, max_length=400,temperature=1)
